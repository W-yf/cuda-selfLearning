...
本图谱定义长期主线中的知识依赖、优先级、掌握目标和证据门槛。它用于决定后续资源选择与学习顺序，不是 30 天日程，也不代表 Day 1 已经开始。
...
| 模板元编程与高级泛型 | 能阅读常用形式；不把复杂技巧作为当前目标 |
...
- [ ] 用户确认知识图谱与能力基线足以进入资源选择。

在以上剩余条件完成前，不选择完整资源组合、不制定 30 天计划、不开始 Day 1。
